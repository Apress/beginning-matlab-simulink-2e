...
%% Alternative plot with ezplot
figure(3); 
fplot3(@(t)cos(t),@(t)sin(t), @(t)0.1*t, [0,10*pi]); hold on
fplot3(@(t)cos(t), @(t)sin(t), @(t)0.2*t, [0, 10*pi]),
fplot3(@(t)cos(t), @(t)sin(t), @(t)-0.1*t, [0, 10*pi])
